...
## Docs
Documentation is available in the [wiki](https://github.com/mattiagalli-sudo/simple-counter/wiki). It's currently still empty, so please consider expanding it!
