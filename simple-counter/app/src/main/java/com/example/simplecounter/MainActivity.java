...
public class MainActivity extends Activity {
    ...
    private void updateCounterViews() {
        ...
        counterText.setText(formatValue(counter, prefs.getString(KEY_COUNTER_LABEL, "")));
        derivedText.setText(formatValue(counter * multiplier, prefs.getString(KEY_DERIVED_LABEL, "")));
    }

    private String formatValue(int value, String label) {
